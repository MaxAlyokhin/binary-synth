...
**Видео**: https://youtu.be/5LMYiLwfvRg?si=D9GdKJF3hmjvw4fg&t=654

**Концерт и лекция**: https://youtu.be/Vj476GVtHZU?si=y4QY3JSnzjmhn5ur

**Статья**: https://bs.stranno.su/drone-ambient-noise-synthesizer ([Dev.to](https://dev.to/max_alyokhin/drone-ambient-noise-synthesizer-in-javascript-when-instability-is-a-feature-not-a-bug-34i8) | [Habr](https://habr.com/ru/articles/970404))

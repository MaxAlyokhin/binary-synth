...
- `Inertia` — коеффициент, при котором при слайде мышью в интерактивном режиме значение будет по инерции изменяться даже после слайда. Чем выше, тем медленнее будет затухать значение.
